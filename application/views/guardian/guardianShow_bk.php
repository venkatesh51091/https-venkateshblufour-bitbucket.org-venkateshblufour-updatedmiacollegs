                            ...
                            if (empty($student_due_fee)) {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody id="fee_sec">
										...
										foreach ($student_due_fee as $key => $studnt)
										{
											
											$fee = $studnt['student_fee'][0];
											$_dicount = 0;
											if(!empty($studnt['student_fee']))
											{
												foreach($studnt['student_fee'] as $ky=>$val)
												{
													if(($key+1)==2)
													{
                                        ...
                                        ?>
											<tr>
												...
												<td><?php echo $student_due_fee[$key]['student_data']['firstname'].'&nbsp;'.$student_due_fee[$key]['student_data']['lastname']; ?></td>
												<td><?php echo $student_due_fee[$key]['student_data']['class']; ?></td>
												...
												<td class="<?php echo $cls; ?> text text-right"><?php echo  ($_dicount>0?'-':'').$currency_symbol .$_dicount; ?></td>
                                        ...
                                        ?>
										<tr>
											<td class="text text-right" colspan="8">Total:- </td>
											<td class="text text-right"><?php echo $currency_symbol.$tot_fee;?></td>
											<td class="text text-right"><?php echo '-'.$currency_symbol.$tot_discount;?></td>
											<td class="text text-right"><?php echo $currency_symbol.$tot_amount;?></td>
										</tr>
                                    </tbody>
                                </table>
                           <?php
