                                ...
                                <div class="col-xs-8 col-xs-offset-2 slide-row">
                                    ...
                                    <div class="slide-content">
                                        ...
                                        <address>
                                            ...
                                            <b><?php echo $this->lang->line('addmission_no'); ?>: </b><?php echo $student['admission_no'] ?><br/>
                                    ...
                                    <div class="slide-footer">
                                        <span class="pull-right buttons">
                                            <a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>" class="btn btn-info btn-xs"  data-toggle="tooltip" title="Show" >
                                                <i class="fa fa-reorder"></i> <?php echo $this->lang->line('view'); ?>
                                            </a>
                                            <a href="<?php echo base_url(); ?>student/edit/<?php echo $student['id'] ?>" class="btn btn-warning btn-xs"  data-toggle="tooltip" title="Edit">
