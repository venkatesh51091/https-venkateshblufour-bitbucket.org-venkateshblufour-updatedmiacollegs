                                                ...
                                                if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                    ...
                                                    <td>
                                                        <div class="btn-group pull-right"> 
                                                            ...
                                                            if ($feetype_balance > 0) {
                                                                ?>
                                                                <a href="<?php echo base_url() . 'parent/payment/pay/' . $fee->id . "/" . $fee_value->fee_groups_feetype_id . "/" . $student['id'] ?>" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-paypal"></i> Paypal</a>
                                                                <?php
                                                            }
                                                            ?>
