                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="activity">  
                            ...
                            <table class="table table-striped table-bordered table-hover example2"><tbody>
                                    <tr>
                        ...
                        <div class="tab-pane" id="exam">
                            ...
                            if (empty($examSchedule)) {
                                ...
                                foreach ($examSchedule as $key => $value) {
                                    ?>
                                    <h4 class="with-border"><?php echo $value['exam_name']; ?></h4>
                                    <?php
                                    if (empty($value['exam_result'])) {
                                        ...
                                        <div class="table-responsive"> 
                                            <table class="table table-striped table-bordered table-hover example display">
                                                <thead>
                                                    <tr>
                                                        <th>
