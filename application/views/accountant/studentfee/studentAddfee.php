                                                ...
                                                <td>
                                                    <div class="btn-group pull-right"> 
                                                        ...
                                                        <button type="button" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" 
                                                                ...
                                                                class="btn btn-xs btn-primary pull-right myCollectFeeBtn <?php echo $display_none; ?>"><i class="fa fa-plus"></i></button>
                                                    </div>        
                                                </td>
                                            </tr>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.save_button', function (e) {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {date: date, type: feetype, amount: amount, amount_discount: amount_discount, amount_fine: amount_fine, description: description, student_fees_master_id: student_fees_master_id, fee_groups_feetype_id: fee_groups_feetype_id, payment_mode: payment_mode},
            dataType: 'json',
            success: function (response) {
                $this.button('reset');
