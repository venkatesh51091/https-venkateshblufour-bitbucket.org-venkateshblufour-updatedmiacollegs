        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>accountant/expense"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group <?php if(form_error('exp_head_id')){echo 'has-error';} ?>">
