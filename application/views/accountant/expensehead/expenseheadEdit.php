                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("accountant/expensehead/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                         ...
                         <div class="form-group <?php if(form_error('expensehead')){echo 'has-error';} ?>">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('expense_head'); ?></label>
                            <input id="expensehead" name="expensehead" placeholder="" type="text" class="form-control"  value="<?php echo set_value('expensehead', $expensehead['exp_category']); ?>" />
