      ...
      $(function () { 
        ...
        var areaChartData_expense_Income = {
          ...
          datasets: [
            ...
            {
              label: "Collection",
              fillColor: "rgba(0, 119, 29, 0.6)",
              strokeColor: "rgba(0, 119, 29, 0.6)",
              pointColor: "rgba(0, 122, 29, 0.9)",
              pointStrokeColor: "rgba(0, 119, 29, 0.6)",
              pointHighlightFill: "#fff",
        ...
        var areaChartData_classAttendence = {
          ...
          datasets: [
            ...
            {
              label: "Digital Goods",
              fillColor: "rgba(185, 0, 0, 0.9)",
              strokeColor: "rgba(185, 0, 0, 0.9)",
              pointColor: "rgba(185, 0, 0, 0.9)",
              pointStrokeColor: "rgba(185, 0, 0, 0.9)",
              pointHighlightFill: "rgba(185, 0, 0, 0.9)",
              pointHighlightStroke: "rgba(60,141,188,1)",
              data: days_expense
            }
          ]
        ...
        barChartData.datasets[1].fillColor = "rgba(221, 0, 0, 0.9)";
        barChartData.datasets[1].strokeColor = "rgba(221, 0, 0, 0.9)";
        barChartData.datasets[1].pointColor = "rgba(221, 0, 0, 0.9)";
        var barChartOptions = {        
