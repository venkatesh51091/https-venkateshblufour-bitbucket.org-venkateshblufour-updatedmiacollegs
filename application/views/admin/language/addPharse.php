                            ...
                            <div class="col-md-4">
                                <div class="form-group form-loading">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  placeholder="Enter phrase for key" name="pharses<?php echo $pharses['id']; ?>" class="form-control" value="<?php echo set_value('language', $pharses['pharses']); ?>">
