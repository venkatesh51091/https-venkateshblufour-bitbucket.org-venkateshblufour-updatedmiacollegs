            ...
            <div class="col-md-12">            
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fa fa-users"></i> Users</li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane table-responsive" id="tab_parent">
                            <table class="table table-striped table-bordered table-hover example2" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                        ...
                        <div class="tab-pane table-responsive" id="tab_teacher">
                            <table class="table table-striped table-bordered table-hover example3" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                        ...
                        <div class="tab-pane table-responsive" id="tab_accountant">
                            <table class="table table-striped table-bordered table-hover example4" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                        ...
                        <div class="tab-pane table-responsive" id="tab_librarian">
                            <table class="table table-striped table-bordered table-hover example5" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
