            ...
            <aside class="main-sidebar">             
                <section class="sidebar" id="sibe-box">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php echo set_Topmenu('Guardian Information'); ?>">
                            <a href="#">
                                <i class="fa fa-user-plus"></i> <span>Guardian Management </span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php echo set_Submenu('guardian/search'); ?>"><a href="<?php echo base_url(); ?>guardian/search"><i class="fa fa-angle-double-right"></i> Guardian List</a></li>
                                <li class="<?php echo set_Submenu('guardian/create'); ?>"><a href="<?php echo base_url(); ?>guardian/create"><i class="fa fa-angle-double-right"></i> Add Guardian </a></li>
                        ...
                        <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo set_Submenu('admin/paymentsettings'); ?>"><a href="<?php echo base_url(); ?>admin/paymentsettings"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('paypal_setting'); ?></a></li>
								...
								?>
                                <li class="<?php echo set_Submenu('uses/index'); ?>"><a href="<?php echo base_url(); ?>admin/adminuser"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('admin_users'); ?></a></li>  
								<?php
								}
								?>
                                <li class="<?php echo set_Submenu('uses/index'); ?>"><a href="<?php echo base_url(); ?>admin/users"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('users'); ?></a></li>  
                            </ul>
                        </li>
                    </ul>
                </section>             
