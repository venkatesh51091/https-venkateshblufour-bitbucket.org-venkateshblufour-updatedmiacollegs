            ...
            <aside class="main-sidebar">                
                <section class="sidebar" id="sibe-box">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo set_Topmenu('dashboard'); ?>"><a href="<?php echo base_url(); ?>accountant/accountant/dashboard"><i class="fa fa-user-secret"></i> <?php echo $this->lang->line('my_profile'); ?></a></li>
